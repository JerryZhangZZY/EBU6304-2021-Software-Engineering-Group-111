...
public class MealInfoCard extends JPanel {
    ...
    private Image newimg_normal= img_normal.getScaledInstance(350, 790, java.awt.Image.SCALE_SMOOTH);
    ...
    private Image newimg_vegetarian= img_vegetarian.getScaledInstance(350, 790, java.awt.Image.SCALE_SMOOTH);
    ...
    private Image newimg_halal= img_halal.getScaledInstance(350, 790, java.awt.Image.SCALE_SMOOTH);
    private ImageIcon icon_halal = new ImageIcon(newimg_halal);
    private Border button_chosen = BorderFactory.createLineBorder(new Color(60,179,113),8);
    public MealInfoCard(){
